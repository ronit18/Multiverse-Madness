	...
	<section className={`${styles.paddings} relative z-10`}>
		...
		>
			...
			>
				...
				what you feel in this metaverse world, because this is really
				the madness of the metaverse of today, using only VR devices you
				can easily explore the metaverse world you want, turn your
